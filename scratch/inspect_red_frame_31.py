...
def inspect_red_frame_31():
    ...
    for idx, cnt in enumerate(contours):
        ...
        print(f"Contour {idx} | Area: {area:.0f} | Center: ({cx},{cy}) | Border: {is_border}")
        
    helmet_mask, foot_mask = segmentor._separate_helmet_foot(red_mask, processed, "red")
